    ...
    <div class="keranjang">
        <div class="baris">
            ...
            <div class="tabel-keranjang">
                ...
                <div class="baris-tabel header-tabel">
                    <div class="ceklish"><h3>NO</h3></div>
                    <div class="nama-produkh"><h3>PRODUK</h3></div>
                    <div class="harga-produkh"><h3>Harga</h3></div>
                    <div class="kuantitas-produkh"><h3>Kuantitas</h3></div>
                    <div class="total-hargah"><h3>Total Harga</h3></div>
                    <div class="Aksih"><h3>Action</h3></div>
                </div>
